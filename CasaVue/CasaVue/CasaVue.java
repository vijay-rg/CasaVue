...
class HouseRent extends JFrame
{
	...
	public void constructUI()
	{
		...
		l5=new JLabel(new ImageIcon("F:\\Images\\Home.png"));
	}
...
class Home extends JFrame
{
	...
	public void constructUI()
	{
		...
		Exit= new JButton("EXIT");
		l1= new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\HouseRental.png"));
	}
	public void designUI()
	{
		...
		admin.setBounds(1200,500,200,50);
		p1.add(tenant);
		frame.getContentPane().add(tenant,BorderLayout.CENTER);
		tenant.setBounds(1200,600,200,50);
		p1.add(sign);
		frame.getContentPane().add(sign,BorderLayout.CENTER);
		sign.setBounds(1200,700,200,50);
		p1.add(Exit);
		frame.getContentPane().add(Exit,BorderLayout.CENTER);
		Exit.setBounds(900,700,200,50);
		frame.add(p1);
	}
	public void handleEvent()
	{
...
class AdminLogin extends JFrame
{
	...
	private void constructUI()
	{
		...
		l3=new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Tenant.png"));
		...
		login.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae)
			{
				try
				{
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/houserentalsystem","root","BruceWayne");
...
class AdminInterface extends JFrame
{
	...
	private void constructUI()
	{
		...
		home = new JButton("Home");
		l1= new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Home_2.png"));
	}
	private void designUI()
	{ 	setLayout(new BorderLayout());
		p1.add(l1);
		...
		insert.setBounds(900,450,200,50);
		p1.add(viewFeedback);
		frame.getContentPane().add(viewFeedback,BorderLayout.CENTER);
		viewFeedback.setBounds(900,530,200,50);
		p1.add(view);
		frame.getContentPane().add(view,BorderLayout.CENTER);
		view.setBounds(900,610,200,50);
		p1.add(home);
		frame.getContentPane().add(home,BorderLayout.CENTER);
		home.setBounds(900,690,200,50);
		frame.add(p1);
	}
	private void handleEvent()
	{
...
class Feedback extends JFrame
{
	...
	private String name;
	private String email;private JLabel l1;
	private JButton home,admin;
	Feedback()
	{
		frame = new JFrame();
	...
	private void constructUI()
	{
        ...
        l1= new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Feedback.png"));
	}	
	private void designUI()
	{
        p1.add(l1);
...
class UpdateDetails extends JFrame
{
	...
	private void constructUI()
	{
		...
		t3 = new JTextField();
		t4 = new JTextField();
		l6 = new  JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Living_Room_1.png"));
	}
	private void designUI()
	{
		p1.add(l6);
...
class TenantLogin extends JFrame 
{
	...
	{ 	
		...
		p1.add(login);
		frame.getContentPane().add(login,BorderLayout.CENTER);
		login.setBounds(1080,750,80,30);
		p1.add(home);
		frame.getContentPane().add(home,BorderLayout.CENTER);
		home.setBounds(900,750,80,30);
		p1.add(c1);
...
class House extends JFrame
{
	...
	private void constructUI()
	{
		...
		l7= new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Search_House.png"));
	}
	private void designUI()
	{
		p1.add(l7);
...
class ReportIssue extends JFrame
{
	...
	private void constructUI()
	{
		...
		t1 = new JTextField();
		t2 = new JTextField();
		l5= new JLabel(new ImageIcon("C:\\Users\\Vaibhav\\Desktop\\Screenshots\\Feedback.png"));
